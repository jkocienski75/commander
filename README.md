...
| §4 Channel surface | 🟡 (a) shipped 2026-04-30 — (a1) prompt + `infer` IPC + (a2) React `ChannelSurface`; (b) conversation persistence pending |
