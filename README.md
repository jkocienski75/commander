...
| §4 Channel surface | 🟡 (a) shipped 2026-04-30 — (a1) prompt + `infer` IPC + (a2) React `ChannelSurface`; (a3) output discipline shipped 2026-05-01; (b) conversation persistence pending |
