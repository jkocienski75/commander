...
6. `../doctrine/decisions/0011-personal-commander-tier.md` — the ADR establishing the personal-commander tier and COO's place in it
...
- **Rust** for the backend half (encryption, SQLite access, inference abstraction client) — the operator is taking on Rust as part of this project; the ramp is bounded per `../doctrine/decisions/0011-personal-commander-tier.md` Consequences section
