...
| §3 Onboarding wizard | 🟡 (a) shipped 2026-04-29 — vault lock/unlock + passphrase sentinel; (b)/(c)/(d) pending |
...
Read `README.md` for the authoritative current state. As of 2026-04-29 (Phase 1 §3 (a) shipped; §3 (b)/(c)/(d) pending):
